...
public class Fabric extends SynchronizedPlayerData implements DedicatedServerModInitializer {
    ...
    public void onInitializeServer() {
        ...
        ServerLifecycleEvents.SERVER_STARTING.register(SynchronizedPlayerData::init);
